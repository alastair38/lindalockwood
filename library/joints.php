...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // adding Flickerplate scripts file in the footer
    wp_enqueue_script( 'flickerplate-js', get_template_directory_uri() . '/library/js/flickerplate.js', array( 'jquery' ), '', true );
      
     // register flickerplate stylesheet
    wp_enqueue_style( 'flickerplate-stylesheet', get_template_directory_uri() . '/library/css/flickerplate.css', array(), '', 'all' );
      
         // adding Baguette Box scripts file in the footer
    wp_enqueue_script( 'baguetteBox-js', get_template_directory_uri() . '/library/js/baguetteBox.min.js', array( 'jquery' ), '', true );
      
     // register Baguette Box stylesheet
    wp_enqueue_style( 'baguetteBox-stylesheet', get_template_directory_uri() . '/library/css/baguetteBox.min.css', array(), '', 'all' );
   
    // register main stylesheet
    wp_enqueue_style( 'joints-stylesheet', get_template_directory_uri() . '/library/css/style.css', array(), '', 'all' );
      
    // wp_enqueue_style( 'joints-ie-stylesheet', get_template_directory_uri() . '/library/css/styleie.css', array(), '', 'all' );
    ...
    wp_enqueue_style( 'googlefonts', 'http://fonts.googleapis.com/css?family=Oxygen|Raleway');
