...
?>
<a href='https://pinterest.com/pin/create/button/?url=Linda%20Lockwood&media=<?php $image_id = get_post_thumbnail_id();$image_url = wp_get_attachment_image_src($image_id,'large', true);echo $image_url[0];  ?>&description=<?php echo $title;?>' target='_blank' title='Pin it!'><i class='fi-social-pinterest'></i></a> <a class='email_link' target='_blank' title='Contact Linda about <?php echo the_title();?>' href='mailto:<?php the_author_meta( 'user_email', 1 ); ?>?subject=<?php echo the_title();?>%20-%20Linda-Lockwood.com&body=Linda%2C%20I%27m%20contacting%20you%20to%20inquire%20about%20%22<?php echo the_title();?>%22%2C%20which%20I%20saw%20on%20your%20website.''><i class='fi-mail'></i></a>"><div class="image" style="background: url('<?php echo $url;?>') no-repeat; background-size: cover;"></div></a>
